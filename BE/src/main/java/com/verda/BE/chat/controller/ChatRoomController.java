...
public class ChatRoomController {
    ...
    public Slice<GetChatRoomsFromUserDTO> getRoomsListFromUser(@PathVariable(name = "postId") long postId, Pageable pageable) {
        Slice<GetChatRoomsFromUserDTO> chatListToUser = chatService.getChatListToUser(postId, pageable);
    ...
    public Slice<GetChatRoomsFromUserDTO> getRoomListToUser(HttpServletRequest request, Pageable pageable) {
    ...
    @GetMapping("/rooms/fm")
    public Slice<GetChatRoomsFromFmDTO> getRoomListToFm(HttpServletRequest request, Pageable pageable) {
        long fmId = (Long)request.getAttribute("fmId");
